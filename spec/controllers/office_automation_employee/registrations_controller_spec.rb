...
module OfficeAutomationEmployee
  describe RegistrationsController do
    ...
    context "#create" do
      ...
      it 'will check if same_as_flag is true then current address is same as registered address' do
        ...
        registered_address = Company.find_by(name: "josh software")
        current_address = Company.find_by(name: "josh software")
      ...
      it "will not create user if user with same email-id exist" do
        ...
        Comapny.create(email: 'abc@abc.com', password: 'abcdabcd', password_confirmation: 'abcdabcd')
